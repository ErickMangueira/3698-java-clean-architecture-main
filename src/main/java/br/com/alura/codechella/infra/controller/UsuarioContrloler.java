...
public class UsuarioContrloler {

    private final CriarUsuario criarUsuario;

    private final ListarUsuarios listarUsuarios;

    public UsuarioContrloler(CriarUsuario criarUsuario, ListarUsuarios listarUsuarios) {
    ...
    public List<UsuarioDto> listarUsuarios() {
        return listarUsuarios.obterTodosUsarios().stream().map(u -> new UsuarioDto(u.getCpf(), u.getNome(), u.getNascimento(), u.getEmail())).toList();
    }
}
